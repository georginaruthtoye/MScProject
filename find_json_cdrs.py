...
# objects consist of sequencing data.
#
# Once the script has run, data from each JSON file has been streamed into the
# directory /d/projects/u/tg001/JSON/programs/5_Results/ as separate folders:
#
# (1) Paths: 	Single file listing filepaths of all sample files
# (2) Files:	Numbered files containing contents of each ungzipped sample file
# (3) Parsed:	Numbered files containing parsed sequencing data from each file
# (4) Meta:	    Single file listing parsed metadata for all sample files
# (5) CDRH3s:	Numbered files containing certain sequencing data fields as
#               python dictionaries (sequence_id {key}/CDRH3 AAs {values})
# (6) FASTA:	A FASTA file of CDR-H3 sequences from each file, stored on
